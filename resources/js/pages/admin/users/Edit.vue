    ...
    <div class="topbar">
      <div class="topbar-left">
        ...
        <div>
          ...
          <p class="page-sub">Ubah data pengguna sistem</p>
        </div>
      </div>
    </div>
        ...
        <div class="section">
          ...
          <div class="grid2">
            <div class="field">
              ...
              <input v-model="form.name" type="text" class="input" :class="{ err: errors.name }" />
          ...
          <div class="grid2">
            <div class="field">
              ...
              <input v-model="form.username" type="text" class="input" :class="{ err: errors.username }" />
              <p v-if="errors.username" class="err-msg">{{ errors.username[0] }}</p>
            </div>
            <div class="field">
              <label class="label">Email <span class="req">*</span></label>
              <input v-model="form.email" type="email" class="input" :class="{ err: errors.email }" />
              <p v-if="errors.email" class="err-msg">{{ errors.email[0] }}</p>
            </div>
          </div>
          <div class="grid2">
            <div class="field">
              <label class="label">Password <span class="hint">(kosongkan jika tidak diubah)</span></label>
              <input v-model="form.password" type="password" class="input" :class="{ err: errors.password }" placeholder="Isi untuk mengganti password" />
...
onMounted(async () => {
  try {
    const r = await api.get(`/admin/users/${route.params.id}`)
    const d = r.data.data
    form.value = { name: d.name, username: d.username, email: d.email, password: '', role: d.role, is_active: d.is_active }
