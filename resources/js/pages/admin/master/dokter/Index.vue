        ...
        <table class="tbl">
          ...
          <tbody>
            <tr v-for="(item, i) in data" :key="item.id">
              ...
              <td>
                <div class="actions">
                  <router-link :to="`/admin/master/dokter/${item.id}/edit`" class="act act-edit" title="Edit">
...
.btn-primary{display:inline-flex;align-items:center;gap:.5rem;height:42px;padding:0 1.25rem;border-radius:10px;background:#0d9488;color:#fff;font-size:.9rem;font-weight:700;text-decoration:none;font-family:inherit;border:none;cursor:pointer;transition:all .2s;box-shadow:0 4px 14px rgba(13,148,136,.28)}
...
.av{width:34px;height:34px;border-radius:50%;background:linear-gradient(135deg,#14b8a6,#0d9488);color:#fff;font-size:.75rem;font-weight:700;display:flex;align-items:center;justify-content:center;flex-shrink:0}
